...
import { CardHero, Flex, Link } from '@coneys/core';
import { PlotHero as PlotHeroIcon } from '@coneys/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Coneys. '
              }
              <Link
                target="_blank"
                href="https://github.com/Coneys-Network/coneys-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
