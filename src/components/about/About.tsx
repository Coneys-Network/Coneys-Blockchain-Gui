...
import icon from '../../assets/img/coneys_circle.svg';
...
const url = 'https://coneysnetwork.org';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) 2021 Chia Network, Coneys Network</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/Coneys-Network/coneys-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>
